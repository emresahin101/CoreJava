...
public class Lambda01 {
    ...
    public static int getTheSumOfSquareOfOdds2(List<Integer> nums){
        ...
        reduce(0, Math::addExact);// ihtiyaciniz olan method'u olusturunuz ve method reference kullaniniz.
                                      /*Eğer identity  değerini (toplamada için 0,çarpım için 1 olur)
                                   girersek get() method Kullanmamıza gerek kalmaz.Ve ADDEXACT metodu normal SUM görevini görürür
                                   Normal Sum metodu yok metod referance de.
                                                                                                                       */
    }
    ...
    public static int getTheSumOfSquareOfOdds3(List<Integer> nums){
        return nums.
                ...
                filter(Utils::isOdd).
                map(Utils::getSquare).
                reduce(Math::addExact).  // addExact method u SUM işlemi yapar.Normal sum odında metod yok!!!
