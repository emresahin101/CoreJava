...
public class C03_StringManipulations {
    ...
    public static void main(String[] args) {
        ...
        // ii)Password space icermesin
        boolean second = !pwd.contains(" ");  // boolean ifadelerde ! işareti olumsuz yapmak için kullanılır
          // Ancak normal eşitlik durumlarında != iadesi kullanılır integer ifadelerde !!!!!!!
        // contains(" " )==> icer ! ==> mesin

        //iii)En az 1 tane buyuk harf olsun
        boolean third = pwd.replaceAll("[^A-Z]","").length()>0; //A-Z harfleri dışındakileri hiçlik yap onun length ini al.
